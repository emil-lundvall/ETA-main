...
function esportIntro() {
    return (
        <div className="esport-intro">
            <Fade>
                <div className="intro-section" data-scroll-index="11">
                    <div className="intro-inner-section" >
                        <Fade bottom>
                            <h1>FIRST, WHAT IS ESPORTS<b>?</b></h1>
                        </Fade>
                        <Fade left>
                            <p>Esports (or electronic sports) is a term used to describe competitive video gaming.<br></br><br></br>
                                The difference from standard video gaming is that esports is competitive (human-vs-
                                human) and usually has an engaging spectator element to it, like traditional sports, where skill
                                and professionalism is celebrated.<br></br><br></br>
                                Esports is also unique in that a player’s success is independent of gender, how tall,
                                strong, thin, or fast they are. Though there is certainly valuable insight linking good physical
                                health to enhanced gamer performance, it is ultimately inconsequential whether the gamer
                                stands at 5’2 or 6’8 tall.</p>
                        </Fade>
                    </div>
                </div>
            </Fade>

            <div className="info-esports-section ies-color" data-scroll-index="12">
                <div className="info-esports-inner-section info-reverse">
                    <Fade bottom>
                        <div className="esports-left-text">
                            <div className="esports-title">
                                <Zoom>
                                    <h1>Isn’t it just for the nerds<b>?</b></h1>
                                </Zoom>
                            </div>
                            <div className="esports-text-two">
                                <div className="et-row-two">
                                    <p>No - in fact, over 380 million people watch esports worldwide both online and in
                                        person. More people watched the 2016 world finals of popular esports game League of
                                        Legends (43 million viewers) than the NBA Finals Game 7 that year (31 million viewers).<br></br><br></br>
                                        Esports is a booming global industry where skilled video gamers play competitively.
                                        In the same way that traditional sports have competitions in baseball, basketball, and football,
                                        esports encompasses competitions across a variety of video games.<br></br><br></br>
                                        Contrary to common perception, esports is not simply a phenomenon occurring in the
                                        basements of unemployed twentysomethings; the industry is real, growing globally, and
                                        offers opportunities to connect and engage with passionate audiences across the globe.</p>
                                </div>
                            </div>
                        </div>
                    </Fade>
                    <Fade top>
                        <div className="esports-right-img">
                            <div className="esports-image-one"></div>
                        </div>
                    </Fade>
                </div>
            </div>
            ...
            <div className="info-esports-section ies-color" data-scroll-index="14">
                <div className="info-esports-inner-section">
                    <div className="esports-left-img">
                        <Fade top>
                            <div className="esports-image-two"></div>
                        </Fade>
                    </div>
                    <Fade bottom>
            ...
            <div className="info-esports-section" data-scroll-index="15">
                <div className="info-esports-inner-section info-reverse">
                    <div className="esports-center-text">
                        <div className="esports-title-center">
                            <Zoom>
